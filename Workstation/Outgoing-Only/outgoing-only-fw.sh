...
# This script is designed to block incoming connections from starting, but to allow all outgoing connections. The loopback device is exempt from this
...
# add rules to allow packets from related and established connections through the INPUT chain
